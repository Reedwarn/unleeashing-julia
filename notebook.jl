...
# ╔═╡ 277cc9c9-d37f-4785-aa61-33b6f96c05eb
begin
	using DataFrames
	using CSV
end

# ╔═╡ dc713673-77fb-41f5-92e0-67d5355ecfde
using Plots  # This will install plots

# ╔═╡ 109974f2-426e-4082-9a1a-861504e35d6a
using PlutoUI

# ╔═╡ 04818d76-e6a2-4cfd-bbd0-bf2daac8e2f7
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 5f2634c7-5b21-496f-b31e-1afc8e366882
df.Country_code === df[!, "Country_code"]

# ╔═╡ 347887c0-f5f6-4e0a-a3eb-9c3da8652356
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ de0a0918-01aa-441a-822e-3917bdbf5d5c
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 4f79b2db-0823-4f7a-8bbd-d7ebda5143a0
dates = sg_data[!, "Date_reported"]

# ╔═╡ 9c26e158-f494-4d6a-9feb-2f8d232fcfb2
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 85114caf-8fce-4b62-9333-f2cbe6a0f564
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ a4a16cfd-d562-4fd4-b464-60baf2dd5450
...
# ╔═╡ 23c7a047-f2f6-4036-8f8c-f501d1132cc1
@bind slider_value Slider(0:10:1000)

# ╔═╡ 6b918745-aba3-4d4f-a1dc-a1bd58db76e0
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 6c3cb0a3-a098-4589-838d-c9df4f3de2f1
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ c7355eb4-cbff-4c46-b771-a9bf7f5bd23f
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ c89bd2d5-c11f-492b-8edf-c85e68b3ae9e
